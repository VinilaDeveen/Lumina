...
export default function PhDonationProcessForBloodCamp() {
  // Alert 
  ...
  const submitDonation = async (e) => {
    ...
    const data = {
      ...
      bloodCampId : parseInt(bloodCamp),
      ...
      <div className="D-main">
        <SidemenuComponent userRole={'phlebotomist'} />
        {
          <div className="Aappointments">
            ...
            <form>
              <div className="Main-form phlebotomist" style={{ width: '500px', marginTop: '30px'}}>
